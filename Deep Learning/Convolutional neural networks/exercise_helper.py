...
def fullyConnectedLayer(data_input, num_in, num_out):
    ...
    #         Symbolic tensor of dimensions:(batch_size, # channels * 12 * 12)
    # num_in - number of input units / dimensionality  of input
    #        - integer of value batch_size
    # num_out - number of output units / number of output labels.
